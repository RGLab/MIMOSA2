...
```{r sim}
set.seed(101)
s = simulate_MIMOSA2(effect=1e-4,phi=100000,bg_effect=1e-5,baseline_stim=2e-4,baseline_background = 1e-4)
```
...
```{r confusion}
table(fit=c("R1","R2","R3","R4","NR1","NR2","NR3","NSR","R5")[max.col(fit$inds)],truth = s$truth)
```
