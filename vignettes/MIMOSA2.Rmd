...
```{r sim}
set.seed(100)
s = simulate_MIMOSA2(effect=5e-4,baseline_stim_effect=2.5e-4,phi=10000)
```
...
```{r}
load_all()
fit = with(s, MIMOSA2(Ntot=Ntot,ns1=ns1,nu1=nu1,ns0=ns0,nu0=nu0,tol=1e-10,random=FALSE))
...
plot(fdr[o],cumsum(!s$truth[o]%in%c("R1","R2","R3","R4"))/1:100,type="l",ylab="true fdr",xlab="nominal fdr",xlim=c(0,0.25),ylim=c(0,0.25))
abline(0,1,lty=2)
